...
public class DatabaseClass {
    ...
    public void displayBrand(TableColumn f1, TableColumn f, TableView f2) throws SQLException, ClassNotFoundException {
        Statement st = connection();
    ...
    public void SelectBrand(String name, TableColumn f1, TableColumn f, TableView f2) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public void displayExtra(TableColumn f1, TableColumn f, TableView f2) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public void UpdateExtra(int id, String name) {
        try {
    ...
    public void SelectExtra(String name, TableColumn f1, TableColumn f, TableView f2) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public void displayType(TableColumn f1, TableColumn f, TableView f2) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public void SelectType(String name, TableColumn f1, TableColumn f, TableView f2) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public void displayTypeCombo(ComboBox p) throws SQLException, ClassNotFoundException {
        Statement st = connection();
    ...
    public void displayModelCombo(ComboBox p) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<String> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public int SelectTypeCombo(ComboBox p) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        String f;
        int i = 0;
        f = (String) p.getValue();
    ...
    public int SelectModelCombo(ComboBox p) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        String f;
        int i = 0;
        f = (String) p.getValue();
    ...
    public void AddAutomobile(int type, int model, String price) {
        try {
            float price2 = 0;
    ...
    public boolean selectAll(String name, String query, String f) throws SQLException, ClassNotFoundException {
        boolean p;
        Statement st = connection();
    ...
    public void displayAutomobile(TableColumn f, TableColumn f1, TableColumn f2, TableColumn f3, TableColumn f4, TableView f5) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public void UpdateAutomobile(int id, int type, int model, String price) {
        try {
            float price2 = 0;
            // create our mysql database connection
            Statement st = connection();
    ...
    public void displayCatalog(TableColumn f, TableColumn f1, TableColumn f2, TableColumn f3, TableColumn f4, TableColumn f5, TableView f6) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
    ...
    public void selectCatalog(String name, TableColumn f, TableColumn f1, TableColumn f2, TableColumn f3, TableColumn f4, TableColumn f5, TableView f6) throws SQLException, ClassNotFoundException {
