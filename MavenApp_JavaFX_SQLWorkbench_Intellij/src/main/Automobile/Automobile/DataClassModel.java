...
public class DataClassModel extends DatabaseClass {
    ...
    public void AddModel(String name, String price, String marka, String extra) {
        try {
    ...
    public void displayModel(TableColumn f, TableColumn f1, TableColumn f2, TableColumn f3, TableColumn f4, TableView f5) throws SQLException, ClassNotFoundException {
        Statement st = connection();
    ...
    public void UpdateModel(int id, String name, String price, String marka, String extra) {
        try {
    ...
    public void SelectModel(String name, TableColumn f, TableColumn f1, TableColumn f2, TableColumn f3, TableColumn f4, TableView f5) throws SQLException, ClassNotFoundException {
        Statement st = connection();
        ObservableList<DatabaseClass> oblist = FXCollections.observableArrayList();
        oblist.clear();
