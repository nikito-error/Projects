...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\roklya1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Рокля</p>
                    <h2 class="price-text">30.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\roklya2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Рокля</p>
                    <h2 class="price-text">30.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\roklya3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Рокля</p>
                    <h2 class="price-text">40.00 лв.</h2>
                </div>
            </div>
        </div>
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\roklya4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Рокля</p>
                    <h2 class="price-text">50.00 лв.</h2>
                </div>
            </div>
        </div>
