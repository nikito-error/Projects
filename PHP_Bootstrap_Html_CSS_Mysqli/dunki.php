...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\dunki.png" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Мъжки дънки с джобове</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\dunki1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки със скъсан ефект</p>
                    <h2 class="price-text">22.50 лв.</h2>
                </div>
            </div>
        </div>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\dunki2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Сиви дънки</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\dunki3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки</p>
