...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\qked1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Късо яке</p>
                    <h2 class="price-text">60.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\qked2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Зимно яке</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\qked3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънково яке</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\qked4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Зимно яке</p>
                    <h2 class="price-text">50.00 лв.</h2>
