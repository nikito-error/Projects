...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\ancugm5.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Анцуг Adidas</p>
                    <h2 class="price-text">130.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\ancugm6.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Анцуг Reebok</p>
                    <h2 class="price-text">150.00 лв.</h2>
                </div>
            </div>
        </div>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\ancugm3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Анцуг Lotto</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\ancugm4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Анцуг Adidas</p>
                    <h2 class="price-text">160.00 лв.</h2>
                </div>
            </div>
        </div>
