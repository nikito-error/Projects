...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\dunkid1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки с висока талия</p>
                    <h2 class="price-text">42.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\dunkid2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки</p>
                    <h2 class="price-text">80.00 лв.</h2>
                </div>
            </div>
        </div>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\dunkid3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки със скъсан ефект</p>
                    <h2 class="price-text">36.00 лв.</h2>
                </div>
            </div>
        </div>
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\dunkid4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки</p>
                    <h2 class="price-text">27.00 лв.</h2>
                </div>
            </div>
        </div>
