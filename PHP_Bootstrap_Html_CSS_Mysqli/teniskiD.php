...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\teniskad1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\teniskad2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска</p>
                    <h2 class="price-text">20.00 лв.</h2>
                </div>
            </div>
        </div>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\teniskad3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Къса тениска</p>
                    <h2 class="price-text">35.00 лв.</h2>
                </div>
            </div>
        </div>
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\teniskad4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска</p>
                    <h2 class="price-text">20.00 лв.</h2>
