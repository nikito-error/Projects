...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\teniska1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска Reebok</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\teniska2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска Adidas</p>
                    <h2 class="price-text">40.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\teniska3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска Lotto</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\teniska4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска Adidas</p>
                    <h2 class="price-text">35.00 лв.</h2>
