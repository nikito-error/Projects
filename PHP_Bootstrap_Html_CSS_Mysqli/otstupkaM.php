...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\otstupkaM1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Яке</p>
                     <p class=" line-tr">80.00 лв.</p> <h2 class="price-text discount-color ">40.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\otstupkaM2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\otstupkaM3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Дънки</p>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\otstupkaM4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Блуза</p>
