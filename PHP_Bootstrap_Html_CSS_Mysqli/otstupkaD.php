...
<section class="white-section" id="categories">
    ...
    <div class="row">
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card ">
                <div class="card-header ">
                    <img class="img-fluid rounded" src="images\otstupkaD1.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Рокля</p>
                     <p class=" line-tr">40.00 лв.</p> <h2 class="price-text discount-color ">20.00 лв.</h2>
        ...
        <div class="pricing-column-categ col-lg-3 col-md-6 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\otstupkaD2.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Тениска</p>
                     <p class=" line-tr">20.00 лв.</p> <h2 class="price-text discount-color ">10.00 лв.</h2>
                </div>
            </div>
        </div>
        ...
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\otstupkaD3.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Рокля</p>
                     <p class=" line-tr">50.00 лв.</p> <h2 class="price-text discount-color ">25.00 лв.</h2>
                </div>
            </div>
        </div>
        <div class="pricing-column-categ col-lg-3 col-6">
            <div class="card">
                <div class="card-header">
                    <img class=" img-fluid rounded" src="images\otstupkaD4.jpg" alt="Second slide">
                </div>
                <div class="card-body">
                    <p>Рокля</p>
                     <p class=" line-tr">30.00 лв.</p> <h2 class="price-text discount-color ">15.00 лв.</h2>
                </div>
            </div>
        </div>
