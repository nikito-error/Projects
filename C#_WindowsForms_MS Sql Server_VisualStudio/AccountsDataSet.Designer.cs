...
namespace LibraryApp {
    ...
    public partial class AccountsDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountsRow AddAccountsRow(string fullname, string email, string city, string address, string phone, bool sex, string username, string password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountsRow FindBycode(int code) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public int code {
                get {
                    return ((int)(this[this.tableAccounts.codeColumn]));
                }
                set {
            ...
            public bool sex {
                get {
                    try {
                        return ((bool)(this[this.tableAccounts.sexColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'sex\' in table \'Accounts\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IssexNull() {
                return this.IsNull(this.tableAccounts.sexColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetsexNull() {
                this[this.tableAccounts.sexColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace LibraryApp.AccountsDataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Accounts] ([fullname], [email], [city], [address], [phone], [sex], [username], [password]) VALUES (@fullname, @email, @city, @address, @phone, @sex, @username, @password);
SELECT code, fullname, email, city, address, phone, sex, username, password FROM Accounts WHERE (code = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Accounts] SET [fullname] = @fullname, [email] = @email, [city] = @city, [address] = @address, [phone] = @phone, [sex] = @sex, [username] = @username, [password] = @password WHERE (([code] = @Original_code) AND ([fullname] = @Original_fullname) AND ([email] = @Original_email) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ([username] = @Original_username) AND ([password] = @Original_password));
SELECT code, fullname, email, city, address, phone, sex, username, password FROM Accounts WHERE (code = @code)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT code, fullname, email, city, address, phone, sex, username, password FROM " +
                "dbo.Accounts";
        ...
        public virtual int Delete(int Original_code, string Original_fullname, string Original_email, string Original_city, string Original_address, string Original_phone, global::System.Nullable<bool> Original_sex, string Original_username, string Original_password) {
        ...
        public virtual int Insert(string fullname, string email, string city, string address, string phone, global::System.Nullable<bool> sex, string username, string password) {
            if ((fullname == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_sex.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((bool)(Original_sex.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_username, 
                    string Original_password) {
            return this.Update(fullname, email, city, address, phone, sex, username, password, Original_code, Original_fullname, Original_email, Original_city, Original_address, Original_phone, Original_sex, Original_username, Original_password, Original_code);
        }
    }
