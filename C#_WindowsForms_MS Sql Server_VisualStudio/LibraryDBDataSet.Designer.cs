...
namespace LibraryApp {
    ...
    public partial class LibraryDBDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountsRow AddAccountsRow(string username, string fullname, string email, string password) {
...
namespace LibraryApp.LibraryDBDataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Accounts] WHERE (([username] = @Original_username) AND ([fulln" +
                "ame] = @Original_fullname) AND ([email] = @Original_email) AND ([password] = @Or" +
                "iginal_password))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Accounts] ([username], [fullname], [email], [password]) VALUES" +
                " (@username, @fullname, @email, @password);\r\nSELECT username, fullname, email, p" +
                "assword FROM Accounts WHERE (username = @username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Accounts] SET [username] = @username, [fullname] = @fullname, [email] = @email, [password] = @password WHERE (([username] = @Original_username) AND ([fullname] = @Original_fullname) AND ([email] = @Original_email) AND ([password] = @Original_password));
SELECT username, fullname, email, password FROM Accounts WHERE (username = @username)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, fullname, email, password FROM dbo.Accounts";
        ...
        public virtual int Fill(LibraryDBDataSet.AccountsDataTable dataTable) {
        ...
        public virtual LibraryDBDataSet.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibraryDBDataSet.AccountsDataTable dataTable = new LibraryDBDataSet.AccountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibraryDBDataSet.AccountsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_username, string Original_fullname, string Original_email, string Original_password) {
        ...
        public virtual int Insert(string username, string fullname, string email, string password) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string fullname, string email, string password, string Original_username, string Original_fullname, string Original_email, string Original_password) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fullname, string email, string password, string Original_username, string Original_fullname, string Original_email, string Original_password) {
            return this.Update(Original_username, fullname, email, password, Original_username, Original_fullname, Original_email, Original_password);
        }
    }
